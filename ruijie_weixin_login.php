<?php  
    ...
    {  
        ...
        {  
            ...
            $token = "ruijie";//与在微信配置的token一致，不可泄露  
                        ...
                        if($MsgType == 'text'){  
                            ...
                            if(!empty( $content )){  
                                ...
                                if($content == "10001" || 1){  
									...
									$para_array = array("wxid"=>"$fromUsername");
									$para_json = json_encode($para_array);
									$para = base64_encode($para_json);
                                    $resultStr = sprintf($newsTpl, $fromUsername, $toUsername, $time, 'news',   
                                                $ArticleCount,'点我上网','欢迎光临','http://image.ruijie.com.cn/others/images/UCA_online.png',  
                                                'http://info.3g.qq.com/?para='.$para.'&t='.time());  
                                    echo $resultStr;  
                                    $this->log($resultStr);  
                                }else{  
                                    //回复文本信息  
